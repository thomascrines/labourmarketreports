...
Date <- as.Date(data.table(read_excel("Tables_Online.xlsx", sheet = "Date"))$Value, format = "%d/%m/%Y")
Key_Stats <- data.table(read_excel("Tables_Online.xlsx", sheet = "Key"))
Country_Stats <- data.table(read_excel("Tables_Online.xlsx", sheet = "Countries"))
Region_Stats <- data.table(read_excel("Tables_Online.xlsx", sheet = "Regions"))
Time_Stats <- data.table(read_excel("Tables_Online.xlsx", sheet = "Time"))
