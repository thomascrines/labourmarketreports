...
The data and Markdown folders can also be deleted when reporting process finalised.

The process of making a function to pull and format a dataset for publication should be described in this readme.
...
## Usage - ONS API
The main functionality that has been developed so far is to interact with the ONS API, so it's useful to read through the [documentation](https://developer.ons.gov.uk/) before starting to use the package. The main functions are:
...
If data from the open data platform is required there is an existing package to pull data from the API, [opendatascot](https://github.com/DataScienceScotland/opendatascot).
