...
Date <- as.Date(params$input_date, format = "%d/%m/%Y")
Key_Stats <- data.table(params$key_stats)
Country_Stats <- data.table(params$country_stats)
Region_Stats <- data.table(params$region_stats)
Time_Stats <- data.table(params$time_stats)
